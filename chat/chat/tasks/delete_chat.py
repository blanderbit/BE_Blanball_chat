...
YOU_DONT_HAVE_PERMISSIONS_TO_DELETE_THIS_CHAT_ERROR: str = 'you_dont_have_permissions_to_delete_this_chat'
...
def validate_input_data(data: chat_data) -> None:
    ...
    try:
        ...
        if chat_instance.type == Chat.Type.GROUP or chat_instance.type == Chat.Type.EVENT_GROUP:
